...
- adam/src/fn_fuji/fuji_write_appkey.c
- 8:bool fuji_write_appkey(uint8_t key_id, uint16_t count, uint8_t *data)
- 
- apple2/src/fn_fuji/fuji_appkey_open_write.c
- 11:bool fuji_write_appkey(uint8_t key_id, uint16_t count, uint8_t *data)
- 
- atari/src/fn_fuji/fuji_appkey_open_write.c
- 14:bool fuji_write_appkey(uint8_t key_id, uint16_t count, uint8_t *data)
- 
- coco/src/fn_fuji/fuji_write_appkey.c
- 12:bool fuji_write_appkey(uint8_t key_id, uint16_t count, uint8_t *data)
- 
- commodore/src/fn_fuji/fuji_appkey_open_write.c
- 12:bool fuji_write_appkey(uint8_t key_id, uint16_t count, uint8_t *data)
- 
- fujinet-fuji.h
- 567:bool fuji_write_appkey(uint8_t key_id, uint16_t count, uint8_t *data);
- 
- msdos/src/fn_fuji/fuji_write_appkey.c
- 6:bool fuji_write_appkey(uint8_t key_id, uint16_t count, uint8_t *data)
- 
- pmd85/src/fn_fuji/fuji_write_appkey.c
- 11:bool fuji_write_appkey(uint8_t key_id, uint16_t count, uint8_t *data)
