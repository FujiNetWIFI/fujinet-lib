Feature: library test - apple2 sp_find_modem

  This tests fujinet-network apple2 sp_find_modem

  Scenario: execute apple2 sp_find_modem
    Given apple2-fn-nw application test setup
      And I add common apple2-sp files
      And I add file for compiling "features/apple2/fn_network/invokers/test_sp_find_modem.s"
      And I add file for compiling "../../apple2/src/fn_network/sp_find_modem.s"
