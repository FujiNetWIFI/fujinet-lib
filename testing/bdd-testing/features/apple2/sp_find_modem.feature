Feature: library test - apple2 spn_find_modem
  ...
  Scenario: execute sp.c
    Given apple2-fn-nw application test setup
     ...
     When I execute the procedure at _init for no more than 1450 instructions
    ...
    Then string at _spn_payload+5 contains
     ...
     And I expect to see _spn_payload+4 equal 5

     # return from _spn_find_modem is 5 for Device number
