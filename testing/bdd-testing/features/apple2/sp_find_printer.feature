Feature: library test - apple2 spn_find_printer

  This tests fujinet-network apple2 spn_find_printer
  ...
  Scenario: execute sp.c
    Given apple2-fn-nw application test setup
      ...
      And I add file for compiling "../../apple2/src/spn_find_printer.s"
    ...
    Then string at _spn_payload+5 contains
     ...
     And I expect to see _spn_payload+4 equal 7

     # return from _spn_find_printer is 2 for Device number
