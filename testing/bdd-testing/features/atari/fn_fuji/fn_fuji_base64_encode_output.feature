Feature: IO library test - fn_fuji_base64_encode_output

  This tests FN-FUJI fn_fuji_base64_encode_output

  Scenario: execute _fn_fuji_base64_encode_output
    Given atari-fn-fuji application test setup
      ...
      And I write word at t_fn with address _fn_fuji_base64_encode_output
