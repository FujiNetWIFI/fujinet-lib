Feature: IO library test - fn_fuji_put_host_slots

  This tests FN-FUJI fn_fuji_put_host_slots

  Scenario: execute _fn_fuji_put_host_slots
    Given atari-fn-fuji simple test setup
      And I add common atari-io files
      And I add atari src file "fn_fuji/fn_fuji_get_host_slots.s"
      And I add atari src file "fn_fuji/fn_fuji_put_host_slots.s"
     ...
     When I execute the procedure at _fn_fuji_put_host_slots for no more than 60 instructions
