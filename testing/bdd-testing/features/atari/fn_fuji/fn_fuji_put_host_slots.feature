Feature: IO library test - fn_fuji_put_host_slots
  ...
  Scenario: execute _fuji_put_host_slots
    Given atari-fn-fuji simple test setup
     ...
     When I execute the procedure at _fuji_put_host_slots for no more than 60 instructions
