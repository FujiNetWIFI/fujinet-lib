Feature: IO library test - fn_fuji_put_device_slots
  ...
  Scenario: execute _fuji_put_device_slots
    Given atari-fn-fuji simple test setup
     ...
     # set the slot_offset
     When I execute the procedure at _fuji_put_device_slots for no more than 60 instructions
