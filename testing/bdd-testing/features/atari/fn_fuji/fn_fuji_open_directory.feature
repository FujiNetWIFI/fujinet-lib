Feature: IO library test - fn_fuji_open_directory
  ...
  Scenario: execute _fn_fuji_open_directory with filter and path
    Given atari-fn-fuji application test setup
      And I add common atari-io files
      And I add atari src file "fn_fuji/fn_fuji_open_directory.s"
      ...
      And I write word at t_fn with address _fn_fuji_open_directory
