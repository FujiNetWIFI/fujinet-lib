Feature: IO library test - fn_fuji_get_wifi_enabled
  ...
  Scenario Outline: execute _fn_fuji_get_wifi_enabled
    Given atari-fn-fuji simple test setup
      And I add common atari-io files
      And I add atari src file "fn_fuji/fn_fuji_get_wifi_enabled.s"
    ...
    When I write memory at t_v with <sio_ret>
     And I execute the procedure at _fn_fuji_get_wifi_enabled for no more than 70 instructions
