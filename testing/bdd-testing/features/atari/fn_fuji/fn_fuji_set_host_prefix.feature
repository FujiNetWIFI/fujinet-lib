Feature: IO library test - fn_fuji_set_host_prefix

  This tests FN-FUJI fn_fuji_set_host_prefix

  Scenario: execute _fn_fuji_set_host_prefix
    Given atari-fn-fuji application test setup
      ...
      And I write word at t_fn with address _fn_fuji_set_host_prefix
