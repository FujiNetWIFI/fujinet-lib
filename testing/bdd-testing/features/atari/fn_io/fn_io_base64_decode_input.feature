Feature: IO library test - fn_io_base64_decode_input

  This tests FN-IO fn_io_base64_decode_input

  Scenario: execute _fn_io_base64_decode_input
    Given atari-fn-io application test setup
      ...
      And I write word at t_fn with address _fn_io_base64_decode_input
     When I execute the procedure at _init for no more than 120 instructions

    # check the DCB values were set correctly
    Then I expect to see DDEVIC equal $70
     And I expect to see DUNIT equal $01
     And I expect to see DCOMND equal $cc
