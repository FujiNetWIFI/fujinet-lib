Feature: IO library test - fn_io_hash_output

  This tests FN-IO fn_io_hash_output

  Scenario: execute _fn_io_hash_output
    Given atari-fn-io application test setup
      And I add common atari-io files
      And I add atari src file "fn_io/fn_io_hash_output.s"
      And I add file for compiling "features/atari/fn_io/test-apps/test_bww.s"
      ...
      And I write word at t_fn with address _fn_io_hash_output
