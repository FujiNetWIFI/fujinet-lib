Feature: IO library test - fn_io_get_host_prefix

  This tests FN-IO fn_io_get_host_prefix

  Scenario: execute _fn_io_get_host_prefix
    Given atari-fn-io application test setup
      ...
      And I write word at t_fn with address _fn_io_get_host_prefix
     When I execute the procedure at _init for no more than 130 instructions

    # check the DCB values were set correctly
    Then I expect to see DDEVIC equal $70
     And I expect to see DUNIT equal $01
     And I expect to see DCOMND equal $e0
