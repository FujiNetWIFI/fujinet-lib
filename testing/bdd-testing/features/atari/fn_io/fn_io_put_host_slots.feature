Feature: IO library test - fn_io_put_host_slots
  ...
  Scenario: execute _fn_io_put_host_slots
    Given atari-fn-io simple test setup
      ...
      And I add atari src file "fn_io/fn_io_get_host_slots.s"
      And I add atari src file "fn_io/fn_io_put_host_slots.s"
     ...
     When I execute the procedure at _fn_io_put_host_slots for no more than 60 instructions
