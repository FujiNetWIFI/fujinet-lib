Feature: IO library test - fn_io_base64_decode_compute

  This tests FN-IO fn_io_base64_decode_compute

  Scenario: execute _fn_io_base64_decode_compute
    Given atari-fn-io application test setup
      ...
      And I write word at t_fn with address _fn_io_base64_decode_compute
