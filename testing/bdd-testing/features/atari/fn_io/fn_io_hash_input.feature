Feature: IO library test - fn_io_hash_input

  This tests FN-IO fn_io_hash_input

  Scenario: execute _fn_io_hash_input
    Given atari-fn-io application test setup
      And I add common atari-io files
      And I add atari src file "fn_io/fn_io_hash_input.s"
