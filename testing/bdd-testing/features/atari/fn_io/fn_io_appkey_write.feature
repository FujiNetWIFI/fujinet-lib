Feature: IO library test - fn_io_appkey_write

  This tests FN-IO fn_io_appkey_write

  Scenario: execute _fn_io_appkey_write
    Given atari-fn-io application test setup
      And I add common atari-io files
      And I add atari src file "fn_io/fn_io_appkey_write.s"
      ...
      And I write word at t_fn with address _fn_io_appkey_write
