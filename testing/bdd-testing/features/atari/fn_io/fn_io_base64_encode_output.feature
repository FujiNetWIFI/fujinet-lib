Feature: IO library test - fn_io_base64_encode_output

  This tests FN-IO fn_io_base64_encode_output

  Scenario: execute _fn_io_base64_encode_output
    Given atari-fn-io application test setup
      And I add common atari-io files
      And I add atari src file "fn_io/fn_io_base64_xxcode_io.s"
      And I add atari src file "fn_io/fn_io_crypto_common.s"
      ...
      And I write word at t_fn with address _fn_io_base64_encode_output
     When I execute the procedure at _init for no more than 120 instructions

    # check the DCB values were set correctly
    Then I expect to see DDEVIC equal $70
     And I expect to see DUNIT equal $01
     And I expect to see DCOMND equal $cd
