Feature: IO library test - fn_io_appkey_read

  This tests FN-IO fn_io_appkey_read

  Scenario: execute _fn_io_appkey_read
    Given atari-fn-io application test setup
      ...
      And I write word at t_fn with address _fn_io_appkey_read
