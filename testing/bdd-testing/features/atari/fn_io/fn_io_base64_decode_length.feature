Feature: IO library test - fn_io_base64_decode_length

  This tests FN-IO fn_io_base64_decode_length

  Scenario: execute _fn_io_base64_decode_length
    Given atari-fn-io application test setup
      And I add common atari-io files
      And I add atari src file "fn_io/fn_io_base64_xxcode_length.s"
      ...
      And I write word at t_fn with address _fn_io_base64_decode_length
