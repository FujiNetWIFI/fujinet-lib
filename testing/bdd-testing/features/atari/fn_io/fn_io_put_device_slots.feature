Feature: IO library test - fn_io_put_device_slots
  ...
  Scenario: execute _fn_io_put_device_slots
    Given atari-fn-io simple test setup
      ...
      And I add atari src file "fn_io/fn_io_get_device_slots.s"
      And I add atari src file "fn_io/fn_io_put_device_slots.s"
     ...
     # set the slot_offset
     When I execute the procedure at _fn_io_put_device_slots for no more than 60 instructions
