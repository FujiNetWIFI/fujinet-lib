Feature: IO library test - fn_io_appkey_open

  This tests FN-IO fn_io_appkey_open

  Scenario: execute _fn_io_appkey_open
    Given atari-fn-io application test setup
      And I add common atari-io files
      And I add atari src file "fn_io/fn_io_appkey_open_read.s"
      ...
      And I write word at t_fn with address _fn_io_appkey_open
    ...
    Then I expect to see DDEVIC equal $70
     ...
     And I expect to see DBYTLO equal 6
